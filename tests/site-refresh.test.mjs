...
function fixture({ failFile = "", htmlScript = false } = {}) {
  ...
  const cached = new Map([
    ["invasive-transect-app-v2.3.2-header-refresh-species-2026-2", new Map([["./app.js", "old app"]])],
...
test("refresh replaces stale app files from network and leaves other sites' caches alone", async () => {
  ...
  assert.equal(cached.get("invasive-transect-app-v2.3.2-header-refresh-species-2026-2").get("./app.js"), "fresh ./app.js");
  assert.equal(cached.get("invasive-transect-app-v2.3.2-header-refresh-species-2026-2").get("./site-refresh.js"), "fresh ./site-refresh.js");
...
for (const options of [{ failFile: "./app.js" }, { htmlScript: true }]) {
  test(`failed refresh preserves old cache: ${JSON.stringify(options)}`, async () => {
    ...
    assert.equal(cached.get("invasive-transect-app-v2.3.2-header-refresh-species-2026-2").get("./app.js"), "old app");
