...
if (!app.includes('href="./instructor.html"') || !config.includes('appVersion: "2.1.0"')) {
  throw new Error("The deployed student interface is not the 2.1.0 instructor-dashboard release.");
}
...
if (
  !worker.includes("invasive-transect-app-v2.1.0")
